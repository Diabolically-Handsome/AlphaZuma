...
from tools import build_alphazuma_55_polar_wide_successor_intent as builder
...
def test_intent_freezes_gate_and_fresh_formal_ranges(tmp_path: Path) -> None:
    ...
    _write(
        validation,
        {
            ...
            "decision_rule": {
                "ranking": ["wins_desc", "level_coverage_desc"]
            },
