...
CAMPAIGN_ID = "alphazuma-55-motor-observable-replay-s99081614-v2"
ANCHOR_SEED_BASE = 1_543_001_000
ANCHOR_SEED_LAST = 1_543_001_164
STUDENT_SEED_BASE = 1_543_001_165
STUDENT_SEED_LAST = 1_543_001_329
MODEL_SEED = 1_543_001_500
...
def build(*, project_root: Path, output: Path) -> dict[str, Any]:
    ...
    startup_incident = (
        ...
        "s99081613-startup-incident-v1.json"
    )
    ...
    preregistration = {
        ...
        "predecessor_startup_incident": _reference(startup_incident),
        ...
        "run": {
            "id": "alphazuma55-motor-observable-replay-v2-5080",
            "run_dir": str(run_dir),
            "device": "cuda:1",
            "policy_architecture": (
