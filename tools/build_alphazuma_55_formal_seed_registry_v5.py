"""Append the motor-observable successor to the global formal seed registry."""
...
CAMPAIGN_ID = "motor-observable-successor-s99081618"
...
def build(*, project_root: Path, master_path: Path, output: Path) -> dict[str, Any]:
    ...
    if controller._sha256(predecessor) != EXPECTED_V4_SHA256:
    ...
    if not (
        ...
        raise ValueError("unexpected motor successor master")
            ...
            "ranges": [
                ...
                },
                {
                    ...
                    "last": (
                        ...
                        * controller.CONTINUOUS_CAMPAIGNS
                        - 1
                    ),
                },
            ],
