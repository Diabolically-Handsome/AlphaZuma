"""Audit the seven-route AlphaZuma 55 single-policy goal."""
...
from tools import (
    audit_alphazuma_55_configured_successor_result_replay_anchor_v1 as replay_anchor,
)
from tools import audit_alphazuma_55_single_policy_goal_v3 as v3
...
def _production_recomputers() -> dict[str, dict[str, Any]]:
    recomputers = v3._production_recomputers()
    recomputers["configured_successor_replay_anchor_v1"] = {
        "path": replay_anchor.SCRIPT_PATH,
        "call": replay_anchor.audit,
    }
    return recomputers
...
def audit(
    ...
    *,
    ...
    original_script = v3.SCRIPT_PATH
    try:
        ...
        v3.SCRIPT_PATH = original_script
