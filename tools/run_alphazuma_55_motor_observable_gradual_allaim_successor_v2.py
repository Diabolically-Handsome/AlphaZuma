"""Conditionally certify the timeout-compatible all-actions engineering winner."""
...
from tools import (
    audit_alphazuma_55_motor_observable_gradual_allaim_postprocess_v2
    as engineering_auditor,
)
from tools import (
    run_alphazuma_55_motor_observable_gradual_allaim_postprocess_v2
    as engineering,
)
from tools import (
...
FINAL_SEED_BASE = legacy.FINAL_SEED_BASE
CONTINUOUS_SEED_BASE = legacy.CONTINUOUS_SEED_BASE
EXPECTED_CAMPAIGN = (
...
def main(argv: list[str] | None = None) -> int:
    ...
    _require(
        ...
        "all-actions V2 successor master hash differs",
    )
