"""Watch the configured V2 controller and invoke its bound V2 auditor."""
...
from tools import run_alphazuma_55_configured_successor_certification_v2 as controller
