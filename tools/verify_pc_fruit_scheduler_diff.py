"""Freeze a source-bound natural fruit-scheduler simulator differential."""
...
from zuma_rl.pc_fruit_scheduler_diff import (
...
IMPLEMENTATION_PATHS = (
    ...
    "src/zuma_rl/pc_fruit_scheduler_diff.py",
    "tools/verify_pc_fruit_scheduler_diff.py",
)
