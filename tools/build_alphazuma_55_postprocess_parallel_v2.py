...
EVALUATION_PARALLEL_ENVS_PER_SHARD = 112
EVALUATION_PARALLELISM_DECISION = (
    PROJECT_ROOT
    / "diagnostics"
...
def build(
    *,
    ...
    implementations = {
        ...
        / "tools"
        / "run_alphazuma_55_postprocess_parallel_v2.py",
    ...
    return {
        ...
        "evaluation_execution": {
            ...
            "parallel_envs_per_shard": EVALUATION_PARALLEL_ENVS_PER_SHARD,
            "basis": "nonformal engineering-registry throughput benchmark",
            "decision_receipt": _artifact(EVALUATION_PARALLELISM_DECISION),
        },
