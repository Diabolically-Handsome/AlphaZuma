"""Freeze a source-bound natural fruit-expiry simulator differential."""
...
from zuma_rl.pc_fruit_expiry_diff import compare_fruit_expiry_transition
...
IMPLEMENTATION_PATHS = (
    ...
    "src/zuma_rl/pc_fruit_expiry_diff.py",
    "tools/verify_pc_fruit_expiry_diff.py",
)
...
def _relative(path: Path, root: Path) -> str:
    ...
    try:
        ...
        raise ValueError("artifact is outside evidence root") from error
