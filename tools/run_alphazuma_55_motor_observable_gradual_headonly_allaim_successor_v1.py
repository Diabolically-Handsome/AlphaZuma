"""Conditionally certify the head-only all-actions engineering winner."""
...
from tools import (
    audit_alphazuma_55_motor_observable_gradual_headonly_allaim_postprocess_v1
...
FINAL_SEED_BASE = 4_100_000_000
CONTINUOUS_SEED_BASE = 4_200_000_000
EXPECTED_CAMPAIGN = (
...
def main(argv: list[str] | None = None) -> int:
    ...
    _require(
        ...
        "factorial successor master hash differs",
    )
