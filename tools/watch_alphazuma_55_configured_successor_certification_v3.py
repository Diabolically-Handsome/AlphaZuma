"""Watch the configured V3 controller and invoke its bound V3 auditor."""
...
from tools import run_alphazuma_55_configured_successor_certification_v3 as controller
